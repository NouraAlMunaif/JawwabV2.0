...
struct Concentration {
    ...
    var card1isShowen = false
     var card2isShowen = false
     var card3isShowen = false
     var card4isShowen = false
     var card5isShowen = false
     var card6isShowen = false
    ...
    mutating func chooseCard(at index: Int) {
        ...
        if let matchIndex = indexOfOneAndOnlyFaceUpCard, matchIndex != index {
            ...
            if cards[matchIndex] == cards[index] {
                ...
                print("pair counter\(pairCounter)")
                print("cards length\(cards.count)")
